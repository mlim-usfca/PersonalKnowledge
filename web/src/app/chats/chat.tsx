...
const ChatComponent: React.FC = () => {
    ...
    const handleCategorySwitch = () => {
        setIsCategoryModalOpen(true); // Remove the unnecessary check for truthiness
                    ...
                    <div className="mb-3">
                        <div className="flex">
                            ...
                            { getUserName() === 'Anonymous' || msg.role === 'system' ?
                                <img className="rounded-full" src="/images/user.png" alt="user" width={35} height={35} />
                                :
                                // <Image src={user?.user_metadata.avatar_url} alt="User Avatar" width={80} height={80} className="rounded-full" />
                                <img src='/images/user2.png' alt="User Avatar" width={35} height={35}  className="rounded-full" />
                            }
                            </div>
