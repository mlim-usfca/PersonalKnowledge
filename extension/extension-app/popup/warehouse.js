  ...
  return new Promise((resolve, reject) => {
    browser.tabs.query({ active: true, currentWindow: true })
      .then((tabs) => {
        ...
        if (tabURL) {
          activeTabURLs.push(tabURL);
          console.log(' current tab URL:', tabURL);
          resolve(activeTabURLs);
        } else {
          resolve([]);
        }
      })
...
// getCurrentWindowTabURLs()
//   .then((tabURLs) => {
//     console.log('Active tab URLs:', tabURLs);
//   })
//   .catch((error) => {
//     console.error('Error getting active tab URLs:', error);
